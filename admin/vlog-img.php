    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4>
                    Image
                    <a href="img-add.php" class="btn btn-primary float-end">Add Img</a>
                </h4>
            </div>
            <div class="card-body">
                <?= alertMessage() ?>
                        ...
                        if (mysqli_num_rows($imgadd) > 0) {
                            foreach ($imgadd as $imgitem) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="vlog-img-edit.php?id= <?= $imgitem['id'];?>" class="btn btn-success btn-sm">Edit</a>

                                        <a href="vlog-img-delete.php?id= <?= $imgitem['id']?>" class="btn btn-danger btn-sm"  onclick="DeleteAlert()">Delete</a>
                                    </td>
                                </tr>
                                <?php
                            }
