    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="medical-img.php" class="btn btn-danger float-end ">Back</a>
            ...
            <div class="card-body">
                ...
                <form action="medical-img-code.php" method="POST" enctype="multipart/form-data">
               ...
               $imageupdate = getById('medical_picture', $imgupdate);
               ...
               if($imageupdate['status']){
                ...
                <div class="mb-3">
                    ...
                    <textarea name="long_description"  required class="form-control" rows="3"><?= $imageupdate['data'] ['long_description'] ?></textarea>
                </div>
                ...
                <div class="mb-2 text-end">
                    <button type="submit" name="medical-Update_img" class="btn btn-primary" >Update Image</button>
                </div>
